...
import static com.rjs.myshows.server.domain.DomainConstants.MOVIE_TYPE;
import static com.rjs.myshows.server.domain.DomainConstants.TV_TYPE;
...
public class TmdbService extends MdbService {
	...
	public TmdbService(ImageService imageService, TmdbProperties tmdbProperties, ObjectMapper jsonObjectMapper,
